defineSuite([
    ...
    createGeometryUpdaterSpecs(EllipseGeometryUpdater, 'ellipse', createBasicEllipse, getScene);

    createDynamicGeometryUpdaterSpecs(EllipseGeometryUpdater, 'ellipse', createDynamicEllipse, getScene);
